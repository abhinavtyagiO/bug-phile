...
export const FETCH_USERS_STATS_START = 'FETCH_USERS_STATS_START';
export const FETCH_USERS_STATS_SUCCESS = 'FETCH_USERS_STATS_SUCCESS';
export const FETCH_USERS_STATS_FAIL = 'FETCH_USERS_STATS_FAIL';

export const FETCH_SEARCH_PROJECT_START = 'FETCH_SEARCH_PROJECT_START';
export const FETCH_SEARCH_PROJECT_SUCCESS = 'FETCH_SEARCH_PROJECT_SUCCESS';
export const FETCH_SEARCH_PROJECT_FAIL = 'FETCH_SEARCH_PROJECT_FAIL';
